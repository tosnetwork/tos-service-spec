...
`tos-messenger` main `48072c6`, OpenFox main `6b997b63`, and `tos-ai` main `96bf0ef`): the component inventory is **5/19 ✅**, with
...
composition, an Event-ID-idempotent durable result publisher, selected live
transport and independent operation are still absent. The remaining
...
Work-package progress (2026-08-22, audited through TOS Core main `a16e1cac3`, `tos-messenger` main `48072c6`, OpenFox main `6b997b63`, and `tos-ai` main `96bf0ef`): **6/29 ✅**, 19/29 🟡, 1/29 ⬜,
