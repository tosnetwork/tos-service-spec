...
Progress snapshot (2026-08-21, audited through `tos-messenger` `961c02d`,
...
two-daemon real-binary evidence; measured route selection, independently
operated/public-network deployment and wire-freeze evidence remain the dominant
gates.
...
publication/hints, bounded stock CLI download/catch-up, and same-host two-daemon
real-binary acceptance are implemented; measured calibration and independent
