...
Progress snapshot (2026-08-21, audited through `tos-messenger` `5eab660`,
...
- an authenticated-peer guard caps distinct head claims, fetches, bytes and
  ...
  it never makes an otherwise false head valid.
