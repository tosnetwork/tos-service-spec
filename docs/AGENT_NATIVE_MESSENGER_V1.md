...
OpenFox `f4087f63`, and `tos-ai` `a9928de`): the component inventory is **5/20 ✅**, with
...
Work-package progress (2026-08-21, audited through `tos-messenger` `182f5c4`, OpenFox `f4087f63`, and `tos-ai` `a9928de`): **6/32 ✅**, 19/32 🟡, 4/32 ⬜,
